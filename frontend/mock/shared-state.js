const SCENARIOS = {
    ...
    err: {
        ...
        recoveryHint: "Remove hair or debris tangled in the main brush",
    },
    alrt: {
        hasError: true,
        kind: "warning",
        ...
        recoveryHint: "Replace the main brush (also tracked on the Maintenance page)",
    },
    mdue: { brushHours: 215, filterHours: 30, sideBrushHours: 40, sensorHours: 35 }, // brush + sensors past their interval
...
const DEFAULT_STATE = {
    ...
    guidedScheduleArmed: false, // Unattended-run gate for scheduled guided cleans; off by default
    sched0Hour: 9,
    sched0Min: 0,
    sched0On: true,
    // Demo: Monday morning slot is a guided clean restricted to "Room A" of the seeded
    // two-room fixture, so the schedule guided panel has a ready example in npm run dev.
    sched0Mode: 2,
    sched0GuidedSession: "mapdata-guided-06.jsonl",
    sched0GuidedZones: "Room A",
    sched1Hour: 9,
    sched1Min: 0,
    sched1On: true,
    sched1Mode: 0,
    ...
    sched0Slot1On: true,
    sched0Slot1Mode: 0,
    sched0Slot1GuidedSession: "",
    sched0Slot1GuidedZones: "",
    sched1Slot1Hour: 15,
    sched1Slot1Min: 0,
    sched1Slot1On: true,
    sched1Slot1Mode: 0,
    sched1Slot1GuidedSession: "",
    sched1Slot1GuidedZones: "",
    sched2Slot1Hour: 15,
    sched2Slot1Min: 0,
    sched2Slot1On: true,
    sched2Slot1Mode: 0,
    sched2Slot1GuidedSession: "",
    sched2Slot1GuidedZones: "",
    sched3Slot1Hour: 15,
    sched3Slot1Min: 0,
    sched3Slot1On: true,
    sched3Slot1Mode: 0,
    sched3Slot1GuidedSession: "",
    sched3Slot1GuidedZones: "",
    sched4Slot1Hour: 15,
    sched4Slot1Min: 0,
    sched4Slot1On: true,
    sched4Slot1Mode: 0,
    sched4Slot1GuidedSession: "",
    sched4Slot1GuidedZones: "",
    sched5Slot1Hour: 0,
    sched5Slot1Min: 0,
    sched5Slot1On: false,
    sched5Slot1Mode: 0,
    sched5Slot1GuidedSession: "",
    sched5Slot1GuidedZones: "",
    sched6Slot1Hour: 0,
    sched6Slot1Min: 0,
    sched6Slot1On: false,
    sched6Slot1Mode: 0,
    sched6Slot1GuidedSession: "",
    sched6Slot1GuidedZones: "",
};
